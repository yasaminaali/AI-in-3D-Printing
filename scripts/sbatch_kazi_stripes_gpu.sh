#!/bin/bash
#=============================================================
# SLURM Batch Script for SA Stripes Dataset Generation on CCRI TamIA
...
#
# Submit with:   sbatch scripts/sbatch_kazi_stripes_gpu.sh
# Check status:  squeue -u $USER
# Cancel job:    scancel <job_id>
# View output:   tail -f sa_stripes_%j.out
#
#SBATCH --job-name=sa_stripes
#SBATCH --output=sa_stripes_%j.out
#SBATCH --error=sa_stripes_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "=============================================="
echo "  SA Stripes Dataset Generation - GPU Pipeline"
...
echo ""
echo "Starting SA stripes pipeline with 4 GPUs..."
echo ""

# --- Run the SA pipeline with kazi_stripes config ---
python3 src/run_pipeline_gpu.py kazi_stripes \
    --gpus 4 \
    --config-dir config
...
echo ""
echo "=============================================="
echo "  SA Stripes Pipeline finished at $(date)"
